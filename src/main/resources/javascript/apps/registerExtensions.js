...
window.jahia.uiExtender.registry.add('callback', 'se-extra-viewsExample', {
    targets: ['jahiaApp-init:60'],
    callback: function () {
        window.jahia.uiExtender.registry.add('adminRoute', 'se-extra-viewsExample', {
        ...
        window.jahia.uiExtender.registry.add('action', 'se-extra-viewsExample', {
