...
<template:addResources type="css" resources="videoCarousel.css" />
...
<c:if test="${jcr:isNodeType(currentNode, 'seaddonsmix:videoCarouselAdvancedSettings')}">
...
<section id="${sliderId}" class="owl-carousel video-carousel ${className}">
	<c:set var="items" value="${jcr:getChildrenOfType(currentNode, 'seaddonsnt:videoCarouselItem')}"/>

	<c:forEach items="${items}" var="item" varStatus="status">

		<template:module node="${item}" nodeTypes="seaddonsnt:videoCarouselItem">
