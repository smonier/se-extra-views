...
<c:choose>
    <c:when test="${levelOfExpertise == 'Beginner'}">
        <c:set var="badgeClass" value="badge badge-success" />
    </c:when>
    <c:when test="${levelOfExpertise == 'Intermediate'}">
        <c:set var="badgeClass" value="badge badge-danger" />
    </c:when>
    <c:when test="${levelOfExpertise == 'Advanced'}">
...
<div class="card">
    <div class="card-body">
      ...
      <div class="pull-right">
        <span class="${badgeClass}"><fmt:message key='seaddonsnt_trainingSession.levelOfExpertise.${levelOfExpertise}'/></span>
        </div>
